...
<?php $form_filter_search -> backend_filter_product('products'); ?>
...
<td><?php echo $this->lib_url->change_order_col("discount","Khuyến mãi")?></td>
<td><?php echo $this->lib_url->change_order_col("mod_noi_bat","Hot")?></td>
...
<?php 
$i = 1;
$this->lib_url->this_module = "products";
foreach($items as $row)
{
        ...
        <td><?php echo ($row['mod_noi_bat'] == 0)? '': 'Yes'; ?></td>
